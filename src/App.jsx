...
const FASES = [
  {
    ...
    missoes: [
      { id: "f1m1", nome: "Instalando NodeJS e VSCode (Windows) + Console.log, variáveis com let/const, tipos primitivos e operadores", xp: 50 },
      { id: "f1m2", nome: "Mais sobre strings, numbers, objeto Math, Arrays (básico), Funções e Objetos (básico)", xp: 50 },
      { id: "f1m3", nome: "Operadores de comparação e lógicos, if/else, switch, for/while + Exercícios com lógica 01–03", xp: 50 },
      { id: "f1m4", nome: "try/catch + Funções: closures, callbacks, IIFE, factory e construtoras", xp: 50 },
      { id: "f1m5", nome: "Filter/Map/Reduce, Prototypes, Classes, 'Validando um CPF' + Promises, Async/Await e Fetch API", xp: 100 },
  ...
  },
  {
    ...
    missoes: [
      { id: "f2m1", nome: "Instalando o TypeScript, ts-node e tsconfig.json + Type Annotations e todos os tipos (any, void, array, tuple, enum...)", xp: 50 },
      { id: "f2m2", nome: "Union Types, Type Alias, Classes em TypeScript, Herança, Interfaces e Type Guards", xp: 50 },
      { id: "f2m3", nome: "Generics, Restrições (constraints), Utility Types + Exercício da Votação", xp: 75 },
  ...
  },
  {
    ...
    missoes: [
      { id: "f3m1", nome: "Seção Node: Módulos, NPM e arquivos com FS", xp: 50 },
      { id: "f3m2", nome: "Express: Introdução, req.params/query/body, Router, Controllers e Middlewares", xp: 75 },
      { id: "f3m3", nome: "MongoDB + Express Session e o Projeto de Contatos (login + CRUD completo)", xp: 75 },
      { id: "f3m4", nome: "API REST: MariaDB + Docker + Insomnia, Sequelize e CRUD de usuários", xp: 75 },
      { id: "f3m5", nome: "Gerando o JWT do usuário + Middleware de verificação + Upload de arquivos", xp: 75 },
  ...
  },
  {
    ...
    missoes: [
      { id: "f4m1", nome: "Diagramas ER + MySQL via Docker Compose + DBeaver: INSERT, SELECT, WHERE, JOINs, GROUP BY e 'Uma consulta real'", xp: 75 },
      { id: "f4m2", nome: "QUERY FINAL: users + containers + teams no erexhost.db (cópia!), sozinho", xp: 125 },
    ],
  },
  {
    id: "f5",
    ...
    missoes: [
      { id: "f5m1", nome: "Windows: criando as chaves SSH e acessando o servidor (use seu Lightsail, pule a criação no Google Cloud)", xp: 50 },
      { id: "f5m2", nome: "Configurando o Git e enviando os arquivos para o servidor", xp: 50 },
      { id: "f5m3", nome: "Instalando o Node e o PM2 + Instalando e configurando o NGINX (Proxy Reverso)", xp: 75 },
      { id: "f5m4", nome: "Comandos Linux/Unix (sudo, ls, cd, nano, jobs/kill) + Deploy da nossa API", xp: 50 },
